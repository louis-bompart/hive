...
public class InventoryTest : MonoBehaviour {
    ...
    public void AddItem()
    {
        ...
        inventoryController.AddItem(100, 5);
        inventoryController.AddItem(101, 5);
        inventoryController.AddItem(102, 5);

        inventoryController.AddItem(103, 5);
        inventoryController.AddItem(104, 5);
        inventoryController.AddItem(105, 5);
    }
}
